...
namespace erp.Migrations
{
    ...
    [Migration("20251109234656_AddTimeTrackingModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("erp.Models.TimeTracking.TimeSheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TotalJustifiedAbsenceDays")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "Year", "Month")
                        .IsUnique()
                        .HasDatabaseName("idx_timesheet_user_period");

                    b.ToTable("TimeSheets", (string)null);
                });

            modelBuilder.Entity("erp.Models.TimeTracking.TimeSheetEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TimeSheetId", "Date")
                        .HasDatabaseName("idx_timesheet_entry_date");
            ...
            modelBuilder.Entity("erp.Models.TimeTracking.TimeSheet", b =>
                {
                    b.HasOne("erp.Models.Identity.ApplicationUser", "ReviewedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("erp.Models.TimeTracking.TimeSheetEntry", b =>
                {
                    b.HasOne("erp.Models.TimeTracking.TimeSheet", "TimeSheet")
                        .WithMany("Entries")
