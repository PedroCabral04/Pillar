...
{
    /// <inheritdoc />
    public partial class FixKanbanBoardCreatedAt : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.DropTable(name: "KanbanCardHistories");
            migrationBuilder.DropTable(name: "KanbanComments");
            migrationBuilder.DropTable(name: "KanbanCardLabels");
            migrationBuilder.DropTable(name: "KanbanLabels");
            
            migrationBuilder.DropColumn(name: "AssignedUserId", table: "KanbanCards");
            migrationBuilder.DropColumn(name: "Priority", table: "KanbanCards");
            migrationBuilder.DropColumn(name: "Color", table: "KanbanCards");
            migrationBuilder.DropColumn(name: "IsArchived", table: "KanbanCards");
            migrationBuilder.DropColumn(name: "CompletedAt", table: "KanbanCards");
            
            migrationBuilder.DropColumn(name: "CreatedAt", table: "KanbanBoards");
        }
    }
}
