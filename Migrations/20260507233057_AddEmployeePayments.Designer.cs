...
namespace erp.Migrations
{
    ...
    [Migration("20260507233057_AddEmployeePayments")]
    partial class AddEmployeePayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("erp.Models.Audit.AuditLogArchive", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("OriginalAuditLogId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("erp.Models.Chatbot.ChatConversation", b =>
                {
                    ...
                    b.Property<int>("DefaultOperationMode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);

                    b.Property<int>("DefaultResponseStyle")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("erp.Models.Chatbot.ChatbotAuditEntry", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("EffectiveMessage")
                        .IsRequired()
                        .HasMaxLength(4000)
                    ...
                    b.Property<string>("EvidenceSourcesJson")
                        .HasColumnType("text");

                    b.Property<bool>("IsConfirmedAction")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ChatbotAuditEntries", (string)null);
                });
            ...
            modelBuilder.Entity("erp.Models.Financial.EmployeePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("ServiceUnitValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.HasIndex("ReferenceMonth", "ReferenceYear");

                    b.HasIndex("EmployeeId", "ReferenceMonth", "ReferenceYear", "Type");
            ...
            modelBuilder.Entity("erp.Models.Financial.SalesGoal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("BonusCommissionPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");
            ...
            modelBuilder.Entity("erp.Models.Financial.ServiceOrderCommission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ServiceOrderCommissions");
                });
            ...
            modelBuilder.Entity("erp.Models.Financial.VendorPerformance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("BonusCommissionEarned")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<bool>("SalesGoalAchieved")
                        .HasColumnType("boolean");

                    b.Property<decimal?>("SalesGoalAchievementPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");

                    b.Property<decimal?>("SalesGoalTarget")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
                    ...
                    b.Property<decimal>("TotalCommissionPending")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)");
            ...
            modelBuilder.Entity("erp.Models.Identity.ModuleActionPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ModulePermissionId", "ActionKey")
                        .IsUnique();

                    b.HasIndex("ModulePermissionId", "DisplayOrder");

                    b.ToTable("ModuleActionPermissions", (string)null);
                });
            ...
            modelBuilder.Entity("erp.Models.Identity.RoleModuleActionPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ModuleActionPermissionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ModuleActionPermissionId");

                    b.HasIndex("RoleId", "ModuleActionPermissionId")
                        .IsUnique();

                    b.ToTable("RoleModuleActionPermissions", (string)null);
                });
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariantCombination", b =>
                {
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariantOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariantOptionValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("erp.Models.ServiceOrders.ServiceOrderAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("erp.Models.Financial.ServiceOrderCommission", b =>
                {
                    ...
                    b.HasOne("erp.Models.ServiceOrders.ServiceOrderItem", "ServiceOrderItem")
                        .WithMany()
            ...
            modelBuilder.Entity("erp.Models.Identity.RoleModuleActionPermission", b =>
                {
                    ...
                    b.HasOne("erp.Models.Identity.ModuleActionPermission", "ModuleActionPermission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("ModuleActionPermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("erp.Models.Identity.ApplicationRole", "Role")
                        .WithMany("ModuleActionPermissions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ModuleActionPermission");
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariantCombination", b =>
                {
                    b.HasOne("erp.Models.Inventory.ProductVariantOptionValue", "OptionValue")
                        .WithMany("VariantCombinations")
                        .HasForeignKey("OptionValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("erp.Models.Inventory.ProductVariant", "Variant")
            ...
            modelBuilder.Entity("erp.Models.Inventory.ProductVariantOptionValue", b =>
                {
                    b.HasOne("erp.Models.Inventory.ProductVariantOption", "Option")
                        .WithMany("Values")
            ...
            modelBuilder.Entity("erp.Models.Sales.SaleItem", b =>
                {
                    ...
                    b.HasOne("erp.Models.Inventory.ProductVariant", "ProductVariant")
                        .WithMany()
            ...
            modelBuilder.Entity("erp.Models.Identity.ApplicationRole", b =>
                {
                    b.Navigation("ModuleActionPermissions");
